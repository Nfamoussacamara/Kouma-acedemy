...
export const createEquipementSchema = yup.object({
  ...
  fournisseur: yup
    .string()
    .matches(objectIdRegex, 'Le fournisseur doit être un identifiant de base de données valide')
...
export const listEquipementsQuerySchema = yup.object({
  ...
  fournisseur: yup.string().matches(objectIdRegex, 'Format d\'identifiant de fournisseur invalide'),
